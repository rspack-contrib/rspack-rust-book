...
You can now run `node examples/plugin/build.js` to see the plugin in action. Check out the output in the `dist/main.js`, and you will see the banner comment added to the top of the file:
